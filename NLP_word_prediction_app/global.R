...
#   "E:\my data science journey\john_hopkins_data_science\JHU_Capstone_project\NLP_word_prediction_app\en_US.corpus.txt"
# )
# 
# 
# 
...
# )
# 
# corpus_filename <- "E:\my data science journey\john_hopkins_data_science\JHU_Capstone_project\NLP_word_prediction_app\en_US.corpus.txt"
...
corpus_path <- paste(
  getwd(),"data/en_US.corpus.txt",sep = "/"
)
corpus_text <- tolower(
...
trigram_list <- generate_ngram(corpus_words,3)
